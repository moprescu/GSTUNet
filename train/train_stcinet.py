...
def main():
    ...
    best_model_name = f'stcinet_dim_horizon_{dim_horizon}_beta_1_{beta_1:.1f}.pth'
    ...
    unetlstm_model = stcinet.STCINet(
    ...
    save_params(params_dict, os.path.join(models_dir, f"stcinet_best_loss_dim_horizon_{dim_horizon}.txt"))
