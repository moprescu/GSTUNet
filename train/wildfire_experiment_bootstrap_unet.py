...
def main():
    ...
    attention = True
    best_model_name = f'unet_dim_horizon_{dim_horizon}_wildfire_bootstrap_{random_seed}.pth'
    ...
    filename = os.path.join(bootstrap_folder, f"unet_{random_seed}.txt")
    d = {}
